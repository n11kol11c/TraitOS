...
; exceptions 0-31 (8,10-14,17 have a CPU-pushed error code)
ISR_NOERR 0
ISR_NOERR 1
ISR_NOERR 2
ISR_NOERR 3
...
; syscall vector 0x80 (int 0x80, DPL-3 gate): ring-3 -> ring-0 entry
global isr128
isr128:
    push qword 0
    push qword 128
...
; Push general registers (rax first => rax at the END of the saved block),
; then hand the register struct pointer to the C handler.
isr_common_stub:
    push rax
    push rbx
    push rcx
